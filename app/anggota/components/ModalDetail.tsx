...
export default function ModalDetail({ open, onOpenChange, anggota }: ModalDetailProps) {
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-2">
            <div className="text-center p-3 bg-blue-50 rounded-lg">
              ...
              <p className="text-xl font-bold text-blue-600 truncate">{anggota.poin}</p>
              <p className="text-xs text-slate-500">Total Poin</p>
            </div>
            <div className="text-center p-3 bg-yellow-50 rounded-lg">
              <Zap className="w-5 h-5 mx-auto mb-1 text-yellow-600" />
              <p className="text-xl font-bold text-yellow-600 truncate">{anggota.streak}</p>
