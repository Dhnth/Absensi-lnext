...
export default function ModalTambah({ open, onOpenChange, onSuccess }: ModalTambahProps) {
    ...
    >
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>Isi data anggota. Email wajib diisi untuk login.</DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            {stokNomor.length === 0 && (
              <p className="text-xs text-red-500">Stok nomor habis! Tambah stok dulu.</p>
            )}
          </div>
