            ...
            {isLibur && (
              <Alert className="bg-yellow-50 border-yellow-200 mb-6">
                ...
                <AlertDescription className="text-yellow-700">
                  Hari ini libur: {keteranganLibur}. Tidak bisa mengajukan izin/sakit.
                </AlertDescription>
              </Alert>
            )}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    >
                      <Clock
                        className={`w-6 h-6 mx-auto mb-2 ${jenis === 'izin' ? 'text-blue-600' : 'text-slate-400'}`}
                      />
                      <p
                        className={`font-medium ${jenis === 'izin' ? 'text-blue-600' : 'text-slate-600'}`}
                      >
                        Izin
                      </p>
                    </button>
                    ...
                    >
                      <FileText
                        className={`w-6 h-6 mx-auto mb-2 ${jenis === 'sakit' ? 'text-blue-600' : 'text-slate-400'}`}
                      />
                      <p
                        className={`font-medium ${jenis === 'sakit' ? 'text-blue-600' : 'text-slate-600'}`}
                      >
                        Sakit
                      </p>
                    </button>
                ...
                <div className="space-y-2">
                  <Label htmlFor="alasan">Alasan {jenis === 'izin' ? 'Izin' : 'Sakit'}</Label>
                  <Textarea
                    id="alasan"
                    value={alasan}
